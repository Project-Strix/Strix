...
from medlp.data_io import CLASSIFICATION_DATASETS, SIAMESE_DATASETS
...
from monai_ex.data import CacheDataset, PersistentDataset, SplitDataset
...
@SIAMESE_DATASETS.register('2D', 'jsph_mvi',
    "/homes/clwang/Data/jsph_lung/MVI/data_crops/datalist-train.json")
def get_25d_dataset(files_list, phase, opts):
    opts['dataset_type'] = SplitDataset
    opts['dataset_kwargs'] = {}
    return get_mvi_dataset(files_list, phase, opts, (70,70), True)
...
def get_mvi_dataset(files_list, phase, opts, spatial_size, use_mask):
    ...
    dataset_type = opts.get('dataset_type', CacheDataset)
    dataset_kwargs = opts.get('dataset_kwargs', {'cache_rate': preload})
